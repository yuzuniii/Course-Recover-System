...
public class DirectoryBean implements Serializable {
    ...
    public void init() {
        ...
        if (loginBean.getCurrentUser() != null && loginBean.getCurrentUser().getRole() != UserRole.ADMIN) {
            viewType = "STUDENTS";
        } else {
    ...
    public void setViewType(String viewType) {
        ...
        if ("USERS".equals(viewType) && (loginBean.getCurrentUser() == null || loginBean.getCurrentUser().getRole() != UserRole.ADMIN)) {
