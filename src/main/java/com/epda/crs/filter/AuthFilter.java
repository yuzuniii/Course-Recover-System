...
public class AuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (path.endsWith("/users.xhtml") || path.endsWith("/audit-log.xhtml") || path.endsWith("/manage-courses.xhtml")) {
            if (currentUser.getRole() == null || currentUser.getRole() != UserRole.ADMIN) {
