...
public class StudentService {
    ...
    public void saveFailedComponent(FailedComponent comp, String actor) {
        if (comp.getComponentId() == null || comp.getComponentId() == 0) {
            ...
            auditLogService.logAction(actor, "UPDATE_FAILED_COMPONENT", "Student", comp.getComponentId(), "Updated failed component: " + comp.getComponentName());
        }
    }
